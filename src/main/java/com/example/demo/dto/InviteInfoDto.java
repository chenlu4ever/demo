...
public class InviteInfoDto {
    ...
    @ApiModelProperty(value = "邀约方",required = false)
    private String inviter;

    @ApiModelProperty(value = "开始时间",required = false, example = "2021-03-04 13:55:33")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date beginTime;

    @ApiModelProperty(value = "结束时间",required = false, example = "2021-03-04 13:55:33")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    ...
    @ApiModelProperty(value = "会议状态 0-待确认 1-会议中 2-已完成 3-未参会",required = false)
    private String meetingStatus;

    @ApiModelProperty(value = "",required = false)
    private String createBy;

    @ApiModelProperty(value = "",required = false, example = "2021-03-04 13:55:33")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date createTime;

    @ApiModelProperty(value = "会议内容",required = false)
