...
public class LoginController {
    ...
    public ModelAndView login(ModelAndView modelAndView,@RequestBody @Valid UserDTO userVo){
        try{
            TblUserInfo tblUserInfo = userInfoService.checkUserLogin(userVo);
            WebUtil.setUserSession(userVo);
